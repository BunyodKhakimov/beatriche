                            ...
                            <div class="main_blog_details">
                                ...
                                <div class="blog_details_left">
                                    <div class="blog_details_img">
                                        <img src="{{asset('/images/blog-details-img1.jpg')}}" alt="" />
                                    </div>
                                ...
                                <div class="blog_comments">
                                        ...
                                        <div class="comment_item">
                                            <div class="col-sm-2">
                                                <div class="blog_comments_img">
                                                    <img class="img-circle" src="{{asset('/images/comment-img1.jpg')}}" alt="">
                                                </div>
                                            </div>
                                            <div class="col-sm-8">
                                    ...
                                    <div class="row">
                                        <div class="comment_item m-l-40">
                                            <div class="col-sm-2">
                                                <div class="blog_comments_img">
                                                    <img class="img-circle" src="{{asset('/images/comment-img2.jpg')}}" alt="">
                                                </div>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="comments_top_tex">
                        ...
                        <div class="col-md-4">
                            <div class="blog_saidbar sm-m-top-70">
                                ...
                                <div class="said_post fix m-top-70">
                                    ...
                                    <div class="post_item">
                                        <div class="item_img">
                                            <img src="{{asset('/images/s-post-img1.jpg')}}" alt="" />
                                        </div>
                                        <div class="item_text">
                                    ...
                                    <div class="post_item">
                                        <div class="item_img">
                                            <img src="{{asset('/images/s-post-img2.jpg')}}" alt="" />
                                        </div>
                                        <div class="item_text">
                                            <h6>it’s been a long day without you</h6>
                                            <p><i class="fa fa-clock-o"></i>  July 20th, 2015</p>
                                    ...
                                    <div class="post_item">
                                        <div class="item_img">
                                            <img src="{{asset('/images/s-post-img3.jpg')}}" alt="" />
                                        </div>
                                        <div class="item_text">
                                            <h6>it’s been a long day without you</h6>
                                            <p><i class="fa fa-clock-o"></i>  July 20th, 2015</p>
                                    ...
                                    <div class="post_item">
                                        <div class="item_img">
                                            <img src="{{asset('/images/s-post-img4.jpg')}}" alt="" />
                                        </div>
                                        <div class="item_text">
                                            <h6>it’s been a long day without you</h6>
                                            <p><i class="fa fa-clock-o"></i>  July 20th, 2015</p>
                                    ...
                                    <div class="post_item">
                                        <div class="item_img">
                                            <img src="{{asset('/images/s-post-img5.jpg')}}" alt="" />
                                        </div>
                                        <div class="item_text">
                                            <h6>it’s been a long day without you</h6>
                                            <p><i class="fa fa-clock-o"></i>  July 20th, 2015</p>
                                ...
                                <div class="said_socail fix m-top-70">
                                    ...
                                    <div class="socail_items m-top-40">
                                        <div class="socail_item">
                                            <img src="{{asset('/images/gram-img1.jpg')}}" alt="" />
                                        </div>
                                        <div class="socail_item">
                                            <img src="{{asset('/images/gram-img2.jpg')}}" alt="" />
                                        </div>
                                        <div class="socail_item">
                                            <img src="{{asset('/images/gram-img3.jpg')}}" alt="" />
                                        </div>
                                        <div class="socail_item">
                                            <img src="{{asset('/images/gram-img4.jpg')}}" alt="" />
                                        </div>
                                        <div class="socail_item">
                                            <img src="{{asset('/images/gram-img5.jpg')}}" alt="" />
                                        </div>
                                        <div class="socail_item">
                                            <img src="{{asset('/images/gram-img6.jpg')}}" alt="" />
                                        </div>
                                    </div>
                                </div>
